...
Many conventional language modeling paradigms rely on assigning a singular target to each input sequence where the label is encoded as a one-hot vector.
